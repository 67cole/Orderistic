      ...
      <div style={{ borderBottom: "1px solid #dfdfdf", padding: "20px 10px 30px 20px"}}>
        ...
        {userReviews
          ? <>
              ...
              <RemoveModal show={showRemove} closeForm={closeRemove} remove={removeCurrentReview}/>
            </>
          : <></>
        }
        </div>
        <Collapse in={editForm}>
          <div style={{ paddingTop: "20px", marginTop: "20px", borderTop: "1px solid #dfdfdf"}}>
            <StarRating handleCurrentRating={handleNewRating} openForm={editForm} newRating={newRating}/>
