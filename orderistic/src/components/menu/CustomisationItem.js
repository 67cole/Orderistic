    ...
    <>
      <ListGroup.Item>
        ...
        <Button
          ...
          style={{ float: "right" }}
          onClick={() => editCustomisation(index)}
        >
          Edit
        </Button>
        ...
        <Collapse in={editing}>
          <div style={{ borderTop: "1px solid #dfdfdf" }}>
            ...
            {newOptions.map((option, index) => (
              ...
              >
                <Form.Control
                  type="text"
                  value={option.option}
                  onChange={(e) => changeOptions(e.target.value, index)}
                />
                <CloseButton
            ...
            <Form.Group className="mb-3" controlId={"limits" + index}>
              <Form.Label>
                How many options can the customer choose?{" "}
              </Form.Label>{" "}
              <br />
              <Form.Select
                aria-label="Up to or exactly"
                value={newSelect}
        ...
        <RemoveModal
          show={showRemove}
          closeForm={closeRemForm}
          remove={() => removeCustomisation(index)}
        />
      </ListGroup.Item>
    </>
  );
