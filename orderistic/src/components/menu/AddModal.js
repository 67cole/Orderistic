...
function AddModal({ show, closeForm }) {
  ...
  const [price, setPrice] = React.useState((1.0).toFixed(2));
      ...
      <Modal show={show} onHide={closeForm} centered size="lg">
        ...
        <Modal.Body style={{ padding: "20px 40px 10px 40px" }}>
          <Form>
            ...
            <Form.Group className="mb-3" controlId="diet-info">
              ...
              />
              <Form.Group className="mt-3" controlId="recommend">
                <Form.Check
                  type={"checkbox"}
                  id={`Recommend`}
            ...
            <CustomisationForm
              customisations={customisations}
              handleCustomisations={handleCustomisations}
            />
            <ListGroup>
